...
/**
 * Interactively create a ItemSet entry and add it to the Kiji table.
 * @author abykovsky
 * @since 12/20/14
 */
public class AddItemSet extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        try {
            ...
            writer.put(itemSetId, ItemSetsFields.INFO_FAMILY.getName(), ItemSetsFields.COUNT.getName(), timestamp, count);
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new AddItemSet(), args));
    }
}
